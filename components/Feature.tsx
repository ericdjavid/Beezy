...
const features = [
  ...
  },
  {
    ...
    description:
      'Fini les tableurs excel pour planifier vos déplacments. Avec Beeliz, organiser ses voyages est incroyablement rapide !',
    icon: ScaleIcon,
  },
  {
          ...
          <div className="grid grid-cols-1 gap-y-16 md:grid-cols-2 md:gap-x-12 md:gap-y-16">
            {features.map((feature) => (
              <div key={feature.name} className="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-yellowbeeliz text-white sm:shrink-0">
